...
jsdocref.addSingletonGetter(LineWrapper);


/**
 * Splits on interword.
 * @param {Array.<jsdocref.publishing.InlineContent>|string} contents Contents
 *     to split.
 ...
 * @param {Array.<jsdocref.publishing.InlineContent>} contents Contents to wrap.
