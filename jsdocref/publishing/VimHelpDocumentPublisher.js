 ...
 * @constructor
 * @extends {jsdocref.publishing.VimHelpContainerPublisher}
 */
var VimHelpDocumentPublisher = function() {
  VimHelpContainerPublisher.call(this);
};
jsdocref.inherits(VimHelpDocumentPublisher, VimHelpContainerPublisher);
jsdocref.addSingletonGetter(VimHelpDocumentPublisher);
 ...
 * @param {jsdocref.publishing.Document} doc Document.
...
jsdocref.inherits(VimHelpContentsTablePublisher, VimHelpContainerPublisher);
jsdocref.addSingletonGetter(VimHelpContentsTablePublisher);
...
VimHelpContentsTablePublisher.prototype.createTopContent = function(doc) {
  ...
  var contents = subs.map(function(sub, i) {
    ...
    idxLen = idx.length;
    ptWidth = jsdocref.TEXT_WIDTH - idxLen - maxLnkLen - /* whites on end */ 2 -
        TABLE_MARGIN;
 ...
 * @param {jsdocref.publishing.Container} sub Sub container.
