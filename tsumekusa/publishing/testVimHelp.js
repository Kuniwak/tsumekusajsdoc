...
var document = new Document(symbolName, 'array.js', '20130212', new Date(), topContent);
...
var ctorContainer = new Container('Summary', 'goog.array-summary', ctorParagraph, true);

document.appendSubContent(ctorContainer);
//}}}


// Static methods {{{
var staticMethodsContainer = new Container('Static methods', 'goog.array-static-methods', null, true);
...
var arrayIndexOfContainer = new Container('goog.array.indexOf', 'goog.array.indexOf', arrayIndexOfParagraph, true);

// Params {{{
var arrayIndexOfParamsContainer = new Container('Parameters', 'goog.array.indexOf-params', null, true);
...
arrayIndexOfParamsContainer.setTopContent(arrayIndexOfParamsDefinitionList);

arrayIndexOfContainer.appendSubContent(arrayIndexOfParamsContainer);
//}}}

// Return {{{
var arrayIndexOfReturnContainer = new Container('Returns', 'goog.array.indexOf-returns', null);
...
arrayIndexOfReturnContainer.setTopContent(arrayIndexOfReturnDefinitionList);

arrayIndexOfContainer.appendSubContent(arrayIndexOfReturnContainer);
//}}}

staticMethodsContainer.appendSubContent(arrayIndexOfContainer);
//}}}

document.appendSubContent(staticMethodsContainer);
//}}}
