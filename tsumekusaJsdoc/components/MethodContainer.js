...
var MemberContainer = require(basePath + '/components/MemberContainer');
 ...
 * @param {jsdoc.Doclet} symbol Method symbol.
 * @return {tsumekusaJsdoc.components.MethodContainer.ParametersContainer}
 ...
 * Creates a parameters container.
 * @param {jsdoc.Doclet} symbol Method symbol.
 * @return {tsumekusaJsdoc.components.MethodContainer.ReturnsContainer}
 ...
 * @param {tsumekusaJsdoc.components.MethodContainer} parent Parent container.
 * @param {?tsumekusaJsdoc.components.DocumentHelper=} opt_docHelper Optional
 *     document helper.
 * @param {?tsumekusaJsdoc.references.ReferenceHelper=} opt_refHelper Optional
 *     reference helper.
