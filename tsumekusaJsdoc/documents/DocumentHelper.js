...
var List = require(tsumekusaPath + '/contents/List');
var InlineCode = require(tsumekusaPath + '/contents/InlineCode');
var Link = require(tsumekusaPath + '/contents/Link');

var basePath = '../../tsumekusaJsdoc';
var tsumekusaJsdoc = require(basePath);
var UnknownInlineTag = require(basePath + '/documents/UnknownInlineTag');
 ...
 * @param {tsumekusaJsdoc.documents.DocumentHelper.TreeNode} node Node.
 ...
 * @type {tsumekusaJsdoc.documents.DocumentHelper.TreeNode}
 * @private
 */
 ...
 * @type {Array.<tsumekusaJsdoc.documents.DocumentHelper.TreeNode>}
 * @private
 */
...
/**
 * Sets a parent node.
 * @param {tsumekusaJsdoc.documents.DocumentHelper.TreeNode} tree Parent tree
 *   node.
 */
 ...
 * @return {?tsumekusaJsdoc.documents.DocumentHelper.TreeNode} Parent tree node
 *     if any.
 */
 ...
 * @return {Array.<tsumekusaJsdoc.documents.DocumentHelper.TreeNode>} Children.
 */
...
/**
 * Appends a tree node.
 * @param {tsumekusaJsdoc.documents.DocumentHelper.TreeNode} tree Tree node to
 *     append.
 */
